export const MESSAGES = {
  en: {
    ...
    verdictStrongFit: "Strong fit", verdictWorthApplying: "Worth applying", verdictStretch: "A stretch", verdictWeakFit: "Weak fit", howToClose: "How to close it:", aiSupplementPanel: "AI-generated analysis, grounded in your CV and this job page. Verify anything material before acting — the source quote behind every point is in the full report.",
  ...
  zh: {
    ...
    verdictStrongFit: "高度匹配", verdictWorthApplying: "值得投递", verdictStretch: "有挑战", verdictWeakFit: "匹配度低", howToClose: "如何补足：", aiSupplementPanel: "由 AI 生成，依据你的简历与本职位页面。执行重要决定前请自行核实 —— 每一条结论对应的原文证据都在完整报告中。",
