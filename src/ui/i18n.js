export const MESSAGES = {
  en: {
    ...
    paired: "Paired to 127.0.0.1:{port}. Available: {providers}.", bridgeUnavailable: "Saved pairing at 127.0.0.1:{port} is unavailable. Start or re-pair the Bridge.", bridgePaired: "Local AI Bridge paired.", pairingFailed: "Bridge pairing failed.", bridgeDisconnected: "Local Bridge disconnected. Restart it before pairing again.", providerNotInstalled: "not found on this machine",
    chooseProviderFirst: "Choose an AI provider first.", aiFinished: "AI analysis completed with {provider}.", requestingAi: "Job captured. Requesting AI analysis", apiKeyNeeded: "Enter a session API key for the selected provider.", directAccessDenied: "Direct access to the selected AI provider was not allowed.", retryAccess: "Allow provider access", aiSupplement: "AI-generated analysis. Every displayed conclusion is accompanied by CV or job-page source evidence; verify anything material before acting.",
    jobUnderstanding: "What this role is", candidatePositioning: "Where you stand", fitNarrative: "How you line up", evidenceRequirements: "Requirements", aiStrengths: "Your strongest evidence", aiGaps: "Gaps to close", aiRisks: "Risks to verify", resumeTailoring: "Tailor your CV", interviewFocus: "Prepare for interview", employerQuestions: "Ask the employer", suggestedActions: "Do this next",
    openReport: "Open full report", reportPrint: "Print or save as PDF", reportModel: "Analysed by", reportGenerated: "Generated", reportSource: "Source", reportFailed: "The report could not be opened.", reportNothingToShow: "Run an analysis first — there is nothing to report yet.", reportUnreadable: "This report could not be read from browser storage.", reportExpired: "This report has expired. Reports are kept for the current browser session only — run the analysis again to make a new one.", analysisFailed: "The analysis could not be completed.", analysing: "Analysing with {model} · {seconds}s",
    sectionPrepare: "Prepare", sectionVerify: "Check before applying", evidenceToggle: "Evidence ({count})", noRequirements: "The model returned no specific requirements for this posting.",
  ...
  zh: {
    ...
    paired: "已配对至 127.0.0.1:{port}。可用：{providers}。", bridgeUnavailable: "已保存的 127.0.0.1:{port} 配对不可用。请启动或重新配对 Bridge。", bridgePaired: "本地 AI Bridge 已配对。", pairingFailed: "Bridge 配对失败。", bridgeDisconnected: "本地 Bridge 已断开。再次配对前请重启它。", providerNotInstalled: "本机未安装",
    chooseProviderFirst: "请先选择 AI 提供商。", aiFinished: "已使用 {provider} 完成 AI 分析。", requestingAi: "职位已读取，正在请求 AI 分析", apiKeyNeeded: "请为选定提供商填写会话 API Key。", directAccessDenied: "未允许直连所选 AI 提供商。", retryAccess: "允许访问该提供商", aiSupplement: "由 AI 生成。每一项展示结论都会附带简历或职位页面的原文证据；执行重要行动前请自行核实。",
    jobUnderstanding: "这个岗位在做什么", candidatePositioning: "你的位置", fitNarrative: "匹配情况", evidenceRequirements: "岗位要求", aiStrengths: "你最有力的证据", aiGaps: "需要补齐的缺口", aiRisks: "需要核实的风险", resumeTailoring: "简历优化方向", interviewFocus: "面试准备重点", employerQuestions: "可以问雇主的问题", suggestedActions: "接下来做什么",
    openReport: "打开完整报告", reportPrint: "打印或另存为 PDF", reportModel: "分析模型", reportGenerated: "生成时间", reportSource: "来源", reportFailed: "无法打开报告。", reportNothingToShow: "请先运行一次分析，目前还没有可生成的报告。", reportUnreadable: "无法从浏览器存储中读取该报告。", reportExpired: "该报告已失效。报告仅在当前浏览器会话内保留，请重新运行分析以生成新的报告。", analysisFailed: "分析未能完成。", analysing: "正在使用 {model} 分析 · {seconds} 秒",
    sectionPrepare: "准备", sectionVerify: "投递前核实", evidenceToggle: "证据（{count}）", noRequirements: "模型未从该职位页面中提取到具体要求。",
