export const MESSAGES = {
  en: {
    ...
    openAiGpt5Mini: "GPT-5 mini (faster, lower cost)", openAiGpt5: "GPT-5 (more capable)", anthropicSonnet5: "Claude Sonnet 5 (balanced)", anthropicOpus5: "Claude Opus 5 (most capable)", anthropicSonnet46: "Claude Sonnet 4.6 (lower cost)", anthropicOpus46: "Claude Opus 4.6", deepseekV4Flash: "DeepSeek V4 Flash (faster, lower cost)", deepseekV4Pro: "DeepSeek V4 Pro (more capable)",
    ...
    jobUnderstanding: "What this role is", candidatePositioning: "Your positioning", fitNarrative: "How you line up", evidenceRequirements: "Requirements", aiStrengths: "Where you are strongest", aiGaps: "Gaps to close", aiRisks: "Risks in the role itself", resumeTailoring: "Tailor your CV", interviewFocus: "What they will ask you", employerQuestions: "What to ask them", cvBlindSpots: "What your CV leaves unanswered", suggestedActions: "Do this next", actionStepsHint: "In order. Everything the analysis asks of you is on this list.",
  ...
  zh: {
    ...
    openAiGpt5Mini: "GPT-5 mini（更快、成本更低）", openAiGpt5: "GPT-5（能力更强）", anthropicSonnet5: "Claude Sonnet 5（均衡）", anthropicOpus5: "Claude Opus 5（能力最强）", anthropicSonnet46: "Claude Sonnet 4.6（成本更低）", anthropicOpus46: "Claude Opus 4.6", deepseekV4Flash: "DeepSeek V4 Flash（更快、成本更低）", deepseekV4Pro: "DeepSeek V4 Pro（能力更强）",
    ...
    jobUnderstanding: "这个岗位具体做什么", candidatePositioning: "你的定位", fitNarrative: "你和岗位怎么对上", evidenceRequirements: "岗位要求", aiStrengths: "你的最强项", aiGaps: "需要补齐的缺口", aiRisks: "这份工作本身的风险", resumeTailoring: "简历优化方向", interviewFocus: "他们会问你什么", employerQuestions: "你该问他们什么", cvBlindSpots: "你的简历没说清楚的地方", suggestedActions: "接下来做什么", actionStepsHint: "按顺序来。这份分析要你做的事，都在这一份清单里。",
