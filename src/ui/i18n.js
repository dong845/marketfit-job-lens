export const MESSAGES = {
  en: {
    ...
    bridgeUnpaired: "Local AI Bridge is not paired.", bridgePort: "Bridge port", pairingCode: "One-time pairing code", pairBridge: "Pair bridge", refreshStatus: "Refresh status", disconnect: "Disconnect", bridgeConnection: "Local AI Bridge connection",
    ...
    aiReview: "AI analysis", aiSupplement: "AI-generated analysis. Every displayed conclusion is accompanied by CV or job-page source evidence; verify anything material before acting.",
  ...
  zh: {
    ...
    bridgeUnpaired: "本地 AI Bridge 尚未配对。", bridgePort: "Bridge 端口", pairingCode: "一次性配对码", pairBridge: "配对 Bridge", refreshStatus: "刷新状态", disconnect: "断开连接", bridgeConnection: "本地 AI Bridge 连接",
    ...
    chooseProviderFirst: "请先选择 AI 提供商。", aiFinished: "已使用 {provider} 完成 AI 分析。", requestingAi: "职位已读取，正在请求 AI 分析", apiKeyNeeded: "请为选定提供商填写会话 API Key。", directAccessDenied: "未允许直连所选 AI 提供商。", retryAccess: "允许访问该提供商",
    aiReview: "AI 分析结果", aiSupplement: "由 AI 生成。每一项展示结论都会附带简历或职位页面的原文证据；执行重要行动前请自行核实。",
